    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative pt-8 pb-20 md:pt-24 md:pb-44 px-6 md:px-12 lg:px-16 xl:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/[0.04] border-t border-l border-white/[0.5] rounded-[8px]"
            style={{ height: "50px" }}
          >
            <Image
              src={NvidiaLogo}
          ...
          <motion.p
            variants={fadeInUp}
            className="text-white/70 text-base sm:text-lg leading-relaxed max-w-full md:max-w-[720px]"
          >
          ...
          >
            ...
            <Link href="#compare-pricing">
              <motion.button
                ...
                whileTap={tapScale}
                className="group bg-[#0C0D10]/30 transition-all border border-white/20 text-white font-normal flex items-center justify-center gap-3 backdrop-blur-sm cursor-pointer whitespace-nowrap px-6"
                style={{
                  width: "200px",
                  height: "50px",
                  borderRadius: "10px",
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="relative hidden lg:flex items-center justify-center lg:justify-end lg:pr-0"
        >
