...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "overflow-clip flex flex-col justify-between bg-[#09001d]/40 rounded-md backdrop-blur-2xl shadow-md shadow-[#311579]",
        className
      )}
      {...props}
    >
      <div className="p-4 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-5 bg-muted/20 rounded w-12 animate-pulse" />
        </div>
        <div className="space-y-2">
          <div className="flex justify-between">
            <div className="h-4 bg-muted/20 rounded w-8 animate-pulse" />
            <div className="h-4 bg-muted/20 rounded w-12 animate-pulse" />
          </div>
          <div className="flex justify-between">
            <div className="h-4 bg-muted/20 rounded w-10 animate-pulse" />
      ...
      <div className="w-full flex h-8 bg-muted/30 justify-between items-center px-3">
        <div className="flex items-center gap-2">
          <div className="h-4 w-4 bg-muted/20 rounded animate-pulse" />
          <div className="h-3 bg-muted/20 rounded w-12 animate-pulse" />
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 bg-muted/20 rounded-full animate-pulse" />
